...
/** Encabezado de orden de compra (R2DBC). Estados: borrador→aprobada→recibida_parcial→recibida_total→cerrada / anulada. */
@Table("orden_compra")
@Getter
@Setter
public class OrdenCompraEntity {
    ...
    @Column("fecha_entrega")        private LocalDate fecha_entrega;
