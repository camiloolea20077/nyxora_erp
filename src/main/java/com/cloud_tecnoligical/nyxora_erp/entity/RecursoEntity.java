...
/** Recurso de costeo (R2DBC, ← cos_recursos). Usado por producto/tercero/movimiento. */
@Table("recurso")
@Getter
@Setter
public class RecursoEntity {
    ...
    @Column("driver")               private String driver;
    @Column("costo_adicional")      private Boolean costo_adicional;
